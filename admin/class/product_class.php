...
class product{
    ...
    public function show_brand(){
        $query = "SELECT * FROM tb_loaisanpham ORDER BY loaisanpham_ten ASC";
    ...
    public function show_product(){
        ...
        ORDER BY tb_loaisanpham.loaisanpham_ten ASC";
        $result = $this -> db ->select($query);
        return $result;
    ...
    public function get_product ($sanpham_id){
        $query = "SELECT * FROM tb_sanpham WHERE sanpham_id = '$sanpham_id'"; 
        $result = $this ->db->select($query);
        return $result;
    }
